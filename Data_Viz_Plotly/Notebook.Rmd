...
df_fulltime_home_win_x <- df_halftime_draw %>% filter(FTR == "H")
...
# Chance, Unentschieden zur Halbzeit und Heimteam gewinnt das Spiel
homewin_after_htdraw_prob <- calc_prob(df_halftime_draw, df_fulltime_home_win_x)
print(homewin_after_htdraw_prob)
print(nrow(df_fulltime_home_win_x))
```
```{r}
